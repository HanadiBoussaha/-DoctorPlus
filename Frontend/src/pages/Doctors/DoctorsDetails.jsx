...
const DoctorsDetails = () => {
 ...
 const { data, loading, error } = useFetchData(`http://localhost:5000/api/v1/doctors/${id}`);
 console.log(data)
 ...
 return  <section>
    ...
    <div>
    <span className="bg-[#CCF0F3] text-irisBlueColor py-1 px-6 lg:py-2 lg:
    px-6 text-[12px] leading-4 lg:text-[16px] lg:leading-7 font-semibold rounded">
    {specialization}
    </span>
