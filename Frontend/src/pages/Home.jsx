...
const Home = () => {
  return (
    <>
         {/* __________hero section ___________*/}
     <section className='hero__section pt-[60px] 2xl:h-[800px]'>
        <div className='container'>
            <div className='flex flex-col lg:flex-row gap-[90px] items-center justify-between'>
                 {/* __________hero content ___________*/}
                <div>
                    <div className='lg:w-[570px]'>
                        ...
                        Lorem Ipsum est un générateur de faux textes aléatoires. Vous choisissez le nombre de paragraphes, de mots ou de listes. Vous obtenez alors un texte aléatoire que vous 
                        pourrez ensuite utiliser librement dans vos maquettes.
                        Lorem Ipsum est un générateur de faux textes aléatoires. Vous choisissez le nombre de paragraphes, de mots ou de listes. Vous obtenez alors un texte aléatoire que vous pourrez ensuite utiliser
                         librement dans vos maquettes.
                        </p>
                        <button className='btn'>Request an Appointment</button>
                          {/* __ hero counter____________ */}
                        <div className='mt-[30px] lg:mt-[70px] flex flex-col lg:flex-row lg:items-center gap-5 lg:gap-[30px]'>
                      
                          <div>
                            <h2
                            className='text-[36px] leading-[56px] lg:text-[44px] lg:leading-[54px] font-[700] text-headingColor'>30+</h2>
                          ...
                          <div>
                            <h2
                            className='text-[36px] leading-[56px] lg:text-[44px] lg:leading-[54px] font-[700] text-headingColor'>15+</h2>
                          ...
                          <div>
                            <h2
                            className='text-[36px] leading-[56px] lg:text-[44px] lg:leading-[54px] font-[700] text-headingColor'>100%</h2>
                        ...
                        {/*  _________hero content ________*/}
                          ...
                          <div className='container'>
                            <div className='lg:w-[470px] mx-auto'>
                              <h2 className='heading text-center'>
                                Providing the best mediacal services
                              </h2>
                        ...
                        {/*____ About section Start _______ */}
                        <About/>
                        ...
                        <ServiceList />
                         ...
                         {/*================ services section end =========== */}
                          ...
                          <ul className="pl-4">
                            ...
                            <li className="text__para">
                            3. View our physicians who are accepting newpatients, use the
